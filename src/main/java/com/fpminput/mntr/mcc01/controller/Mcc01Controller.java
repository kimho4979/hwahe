package com.fpminput.mntr.mcc01.controller;
...
import com.fpminput.mntr.mcc01.service.Mcc01Service;

import egovframework.rte.fdl.property.EgovPropertyService;
import egovframework.rte.psl.dataaccess.util.EgovMap;

@Controller
public class Mcc01Controller extends BaseController{
	...
	@RequestMapping(value="/mcc01/mcc01.do")
	public String SelectSimilarInput(HttpServletRequest pRequest, HttpServletResponse pResponse
		...
		return "/mcc01/similarInput";
	}
	
	@RequestMapping(value="/mntr/mcc01/gridList.json")
	public String similarGridList(HttpServletRequest pRequest, HttpServletResponse pResponse
		...
		try{
			List<EgovMap> list  =  (List<EgovMap>)mcc01Service.selectSimilarList(pRequestParamMap);												
	...
	@RequestMapping(value="/mntr/mcc01/gridListSeq.json")
	public String similarGridListSeq(HttpServletRequest pRequest, HttpServletResponse pResponse
		...
		try{
			List<Mcc01VO> list = (List<Mcc01VO>)mcc01Service.selectSimilarInputSeq(pRequestParamMap);												
	...
	@RequestMapping(value="/mcc01/similarInput_popup.do")
	public String similarInput_popup(HttpServletRequest pRequest, HttpServletResponse pResponse
		...
		return "/mcc01/similarInput_popup";
			
	}
	
	@RequestMapping(value="/mntr/mcc01/insertSimilarInput.json")
	public String insertSimilarInput(HttpServletRequest pRequest, HttpServletResponse pResponse, HttpSession  session
		...
		try {
			...
			mcc01Service.insertSimilarInput(pRequestParamMap);
			...
			if(iterator.hasNext()) {
				...
				mcc01Service.insertSimilarFile(pRequestParamMap);
	...
	@RequestMapping(value="/mntr/mcc01/updateSimilarInfoInput.json")
	@ResponseBody
	public String updateSimilarInfoInput(HttpServletRequest pRequest, HttpServletResponse pResponse, HttpSession  session
		 ...
		 try {
			 ...
			 mcc01Service.updateSimilarInfoInput(pRequestParamMap);
			 ...
			 if(iterator.hasNext()) {
				 ...
				 if(originalFileName != null && !"".equals(originalFileName)){
					 ...
					 mcc01Service.deleteSimilarFileInfoInput(pRequestParamMap);
					 pRequestParamMap.put("CROP_IDX", boardIdx);
					 mcc01Service.insertSimilarFile(pRequestParamMap);
				 }else{
					 mcc01Service.updateSimilarFile(pRequestParamMap); 
				 }
			 }
		} catch (FileNotFoundException e) {
			log.error("입출력 오류 파일을 찾을 수 없습니다!!");
	...
	@RequestMapping(value="/mntr/mcc01/deleteSimilarInfoInput.json")
	public String deleteSimilarInfoInput(HttpServletRequest pRequest, HttpServletResponse pResponse, HttpSession  session
		...
		try{
			for( int x = 0; x < result.length; x++ ){
				...
				for(int i = 0; i < R2.length;i++){
					...
					mcc01Service.deleteSimilarInfoInput(pRequestParamMap);
					mcc01Service.deleteSimilarFileInfoInput(pRequestParamMap);
	 ...
	 @RequestMapping("/mcc01/mcc01FileDown.json")
		public void mab02FileDown(HttpServletRequest pRequest, HttpServletResponse pResponse
			...
			Mcc01VO fileMap = (Mcc01VO) mcc01Service.selectSumNail(seq);
