package com.fpdisys.dist.trans.mapper;
...
import com.fpdisys.dist.trans.domain.TsaleVO;
...
public interface TsaleMapper {
	 ...
	 * @param pReqParamMap
	 */
	void deleteSaleRaw(Map<String, Object> pReqParamMap);
	 ...
	 * @throws Exception
	 */
	void insertSaleRaw(Map<String, Object> pReqParamMap);
	...
	void insertRealAt(Map<String, Object> paramMap);
	...
	void deleteAtMnt(Map<String, Object> pRequestParamMap);

	void insertAtMnt(AtMntVO data);
