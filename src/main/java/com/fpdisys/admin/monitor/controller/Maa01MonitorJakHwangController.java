...
import com.fpdisys.admin.monitor.service.Maa01MonitorJakHwangService;
...
@Controller
public class Maa01MonitorJakHwangController extends BaseController {
	...
	@Autowired
	Maa01MonitorJakHwangService maa01MonitorJakHwangService;
	...
	@RequestMapping(value = "/maa01/maa01MonitorJakHwang.do")
	public String maa01MonitorJakHwang(HttpServletRequest pRequest,
			HttpServletResponse pResponse,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {

		log.info("==========pjhpjh==============");
		List<EgovMap> resultList = (List<EgovMap>) maa01MonitorJakHwangService.maa01MonitorJakHwang(pRequestParamMap);

		return "/admin/Maa01MonitorJakHwang";
	}

	@RequestMapping(value = "/maa01/maa01MonitorJakHwang.json")
	public String maa01MonitorJakHwangList(HttpServletRequest pRequest,
			HttpServletResponse pResponse,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {
	...
	@RequestMapping(value = "/maa01/maa01MonitorJakHwangDetail.json")
	public String maa01MonitorJakHwangDetail(HttpServletRequest pRequest,
			HttpServletResponse pResponse,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {
		...
		try {
			List<EgovMap> resultList = (List<EgovMap>) maa01MonitorJakHwangService.maa01MonitorJakHwangDetail(pRequestParamMap);
	...
	@RequestMapping(value = "/maa01/maa01MonitorJakHwangDate.json")
	public String maa01MonitorJakHwangDate(HttpServletRequest pRequest,
			HttpServletResponse pResponse,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {
		...
		try {
			List<EgovMap> resultList = (List<EgovMap>) maa01MonitorJakHwangService.maa01MonitorJakHwangDate(pRequestParamMap);
	...
	@RequestMapping(value = "/maa01/Maa01MonitorJakHwangPopup.do")
	public String Maa01MonitorJakHwangPopup(HttpServletRequest pRequest,
		...
		return "/admin/Maa01MonitorJakHwang_Popup";

	}

	@RequestMapping(value = "/mab01/Maa01MonitorJakHwangPopupUpdate.json")
	@ResponseBody
	public String Maa01MonitorJakHwangPopupUpdate(HttpServletRequest pRequest,
		...
		try {
			maa01MonitorJakHwangService.Maa01MonitorJakHwangPopupUpdate(pRequestParamMap);
	...
	@RequestMapping(value = "/maa01/maa01MonitorJakHwangReLoad.json")
	public String maa01MonitorJakHwangReLoad(HttpServletRequest pRequest,
			HttpServletResponse pResponse,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {
		...
		try {
			List<EgovMap> resultList = (List<EgovMap>) maa01MonitorJakHwangService.maa01MonitorJakHwangReLoad(pRequestParamMap);
	...
	@RequestMapping(value = "/maa01/deleteMonitorJakHwangtDetail.json")
		...
		try {
			...
			for (int x = 0; x < result.length; x++) {
				...
				for (int i = 0; i < R2.length; i++) {
					...
					maa01MonitorJakHwangService.deleteMonitorJakHwangtDetail(pRequestParamMap);
				}
	...
	@RequestMapping(value = "/maa01/maa01MonitorJakHwang_Date.json")
	public String maa01MonitorJakHwang_Date(HttpServletRequest pRequest,
			HttpServletResponse pResponse,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {
		...
		try {
			List<EgovMap> resultList = (List<EgovMap>) maa01MonitorJakHwangService.maa01MonitorJakHwang_Date(pRequestParamMap);
	...
	@RequestMapping(value = "/maa01/Maa01MonitorJakHwangPopupInsert.json")
	@ResponseBody
	public String Maa01MonitorJakHwangPopupInsert(HttpServletRequest pRequest,
			HttpServletResponse pResponse, HttpSession session,
			@RequestParam Map<String, Object> pRequestParamMap,
			MultipartHttpServletRequest request, ModelMap model) {
		...
		if (iterator.hasNext()) {
			...
			try {
				...
				maa01MonitorJakHwangService.Maa01MonitorJakHwangPopupInsert(pRequestParamMap);
				...
				maa01MonitorJakHwangService.Maa01MonitorJakHwangFileInsert(pRequestParamMap);
