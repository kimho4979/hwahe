...
import com.fpdisys.admin.monitor.service.Maa01MonitorSobiService;
...
@Controller
public class Maa01MonitorSobiController extends BaseController {
	...
	@Autowired
	Maa01MonitorSobiService maa01MonitorSobiService;

	@RequestMapping(value = "/maa01/maa01MonitorSobi.do")
	public String maa01MonitorJakHwang(HttpServletRequest pRequest,
		...
		return "/admin/Maa01MonitorSobi";
	}

	@RequestMapping(value = "/maa01/maa01MonitorSobi.json")
	public String maa01MonitorSobi(HttpServletRequest pRequest,
			HttpServletResponse pResponse,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {
		...
		try {
			List<EgovMap> resultList = (List<EgovMap>) maa01MonitorSobiService.maa01MonitorSobi(pRequestParamMap);
	...
	@RequestMapping(value = "/maa01/maa01MonitorSobiDetail.json")
	public String maa01MonitorSobiDetail(HttpServletRequest pRequest,
			HttpServletResponse pResponse,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {
		...
		try {
			List<EgovMap> resultList = (List<EgovMap>) maa01MonitorSobiService
					.maa01MonitorSobiDetail(pRequestParamMap);
	...
	@RequestMapping(value = "/maa01/Maa01MonitorSobiPopup.do")
	public String Maa01MonitorSobiPopup(HttpServletRequest pRequest,
			HttpServletResponse pResponse,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {
		...
		return "/admin/Maa01MonitorSobi_Popup";

	}

	@RequestMapping(value = "/maa01/Maa01MonitorSobiPopupUpdate.json")
	public String Maa01MonitorSobiPopupUpdate(HttpServletRequest pRequest,
		...
		try {
			maa01MonitorSobiService.Maa01MonitorSobiPopupUpdate(pRequestParamMap);
	...
	@RequestMapping(value = "/maa01/deleteMonitorSobitDetail.json")
	public String deleteMonitorSobitDetail(HttpServletRequest pRequest,
			HttpServletResponse pResponse,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {
		...
		try {
			...
			for (int x = 0; x < result.length; x++) {
				...
				for (int i = 0; i < R2.length; i++) {
					...
					maa01MonitorSobiService.deleteMonitorSobitDetail(pRequestParamMap);
				}
	...
	@RequestMapping(value = "/maa01/maa01MonitorSobi_Date.json")
	public String maa01MonitorSobi_Date(HttpServletRequest pRequest,
		...
		try {
			List<EgovMap> resultList = (List<EgovMap>) maa01MonitorSobiService
					.maa01MonitorSobi_Date(pRequestParamMap);
	...
	@RequestMapping(value = "/maa01/Maa01MonitorSobiPopupInsert.json")
	public String Maa01MonitorSobiPopupInsert(HttpServletRequest pRequest,
			HttpServletResponse pResponse, HttpSession session,
			@RequestParam Map<String, Object> pRequestParamMap, ModelMap model) {
		/*
		...
		try {
			...
			maa01MonitorSobiService.Maa01MonitorSobiPopupInsert(pRequestParamMap);
