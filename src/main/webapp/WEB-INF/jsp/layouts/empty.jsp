...
<head>
    ...
    <!-- TITLE -->
    <title>수급정보 종합시스템 ${title}</title>

   <link rel="shortcut icon" href="/images/iiac_favicon.ico" type="image/x-icon" />
    <link rel="icon" href="/ui/images/iiac_favicon.ico" type="image/x-icon" />
    ...
    <script type="text/javascript" src="<c:url value='/js/common/ax5-polyfill.js' />"></script>
