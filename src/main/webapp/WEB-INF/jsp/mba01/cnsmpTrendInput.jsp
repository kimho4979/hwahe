...
<title>모니터요원 입력시스템-소비동향 입력</title>
  <!-- @@@@@@@@@@@@@@@@@@@@@@ css begin @@@@@@@@@@@@@@@@@@@@@@ -->
...
var BIGO="";
 ...
 function grid_ajax(){
   ...
   function grid_ajax1(){
      $.ajax({
          type : 'post',
          url : "/mntr/mba01/gridListAll.json",
          //data :'&CHUL_NO='+CHUL_NO,
          data : {},
          dataType : '',   	           
          success : function(res){
    	...
    	$('#PUM_NAME').change(function(){
    	 ...
    	 myGrid.setConfig({
    	             ...
    	             colGroup : [
    	                 ...
    	                 {key:"QTY", label:"거래량", width:"80", align:"right", formatter:"money"},    	                                 
    	                 {key:"BIGO", label:"내용", width:"200"},
    	             ...
    	             body : {
    	                 onclick: function(){  
    	                	var gridData = "REG_DATE=" + this.item.REG_DATE+"&PUM_NAME="+this.item.PUM_NAME+"&GOOD_NAME="+this.item.GOOD_NAME+"&CHUL_NO="+this.item.CHUL_NO
	                         +"&QTY="+this.item.QTY+"&BIGO="+this.item.BIGO+"&SEQ_NO="+this.item.SEQ_NO;
    	                	fnObj.modalOpen(gridData);
    	                	 
    	                	 
    	                	/*   app.modal.open({
    	                          url:"/mba01/cnsmpTrendInput_popup.do",
    	                          pars:"REG_DATE=" + this.item.REG_DATE+"&PUM_NAME="+this.item.PUM_NAME+"&GOOD_NAME="+this.item.GOOD_NAME+"&CHUL_NO="+this.item.CHUL_NO
    	                         +"&QTY="+this.item.QTY+"&BIGO="+this.item.BIGO	                                   
    	                      });  */
...
<%@ include file="/WEB-INF/jsp/inc/IncMenu.jsp" %>
	...
	<div class="hw_content"><!--컨텐츠 내용들어가는곳 시작-->
			...
			<h3 class="hw_h3_ma"><!-- <div class="half1_white"></div> --><span class="half_title">소비동향 입력</span></h3>
