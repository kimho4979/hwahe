...
<head>
	...
	<title>모니터요원 입력시스템-월간동향보고서</title>
	<!-- @@@@@@@@@@@@@@@@@@@@@@ css begin @@@@@@@@@@@@@@@@@@@@@@ -->
	...
	var fnObj = {
		...
		getCheckedList: function(){
			...
			$.ajax({
				type : 'get',
				url : "/mntr/mcb01/deleteMonthInfoInput.json",
				data : deleteValue,
				dataType : '',   	           
				success : function(res){                   	 
					grid_ajax();
...
<article>
	<div class="wrap">
		...
		<div class="hw_content"><!--컨텐츠 내용들어가는곳 시작-->
			<h3 class="hw_h3_ma"><span class="half_title">월간동향보고서</span></h3>
