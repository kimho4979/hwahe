...
<%   
	if (request.getParameter("SEQ_NO")==null){
		request.setAttribute("pageTitle", "월간동향보고서 등록"); 
		...
		request.setAttribute("pageTitle", "월간동향보고서 수정");
	...
	form: {
		submit: function(){
			...
			if(confirm("등록하시겠습니까?")==true){
				...
				$.ajax({
					type : "POST",
					url : "/mntr/mcb01/insertMonthInput.json",
					data : formData, 
					contentType: false,
					processData: false,
		...
		submit2: function(){				
			...
			if(confirm("수정하시겠습니까?")==true){
				...
				$.ajax({
					type : "POST",
					url : "/mntr/mcb01/updateMonthInfoInput.json",
					data : formData,
					contentType: false,
					processData: false,
					success : function(res){
	...
	<article>
		<div>
			...
			<form name="send-form" id="send-form" enctype="multipart/form-data">
				...
				<div class="hw_clear"></div>
				<div class="hw_infouse_01">
					<a href="/mcb01/mcb01FileDown.json?seq=${SEQ_NO}">${ORIGINAL_FILE_NAME}</a>
