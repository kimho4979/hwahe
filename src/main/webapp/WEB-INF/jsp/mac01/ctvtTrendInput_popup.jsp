...
<article>
	...
	<div class="ma_content"><!--컨텐츠 내용들어가는곳 시작-->
		...
		<form name="send-form" onsubmit="return false;">
			...
			<h4 class="ma_title">조사일자</h4> <p class="hw_red">일자를 선택해주세요</p>
			<div class="hw_clear"></div>	
			<div class="hw_infouse_01" id="pagesearch" ><label class="hide">조사일자</label><input type="text" name="REG_DATE" id="REG_DATE" class="AXInput W100" value="${REG_DATE}" onkeydown="return false;" />
			</div>
			<div class="hw_clear"></div>
			...
			<div class="hw_clear"></div>
			<h4 class="ma_title">전년대비면적(본인)</h4> <p class="hw_red">전년대비 재배면적(본인)을 선택해주세요</p>
			<div class="hw_clear"></div>	
			<div class="hw_infouse_01">
			 	<input type="radio" name="STATUS" value="1" id="status1" /><label for="status1">증가</label>
			    <input type="radio" name="STATUS" value="2" id="status2" /><label for="status2">비슷</label>
			    <input type="radio" name="STATUS" value="3" id="status3" /><label for="status3">감소</label>
			</div>
			<div class="hw_clear"></div>
			<h4 class="ma_title">재배면적(본인)</h4><p class="hw_red">본인의 재배면적을 입력하세요</p>
			<div class="hw_clear"></div>	
			<div class="hw_infouse_01" >
				<label for="hide">재배면적</label><input name="AREA" id="AXInputMoney" value='${AREA}' class="AXInput" />
				<span>평</span>
			</div>
			<div class="hw_clear"></div>	
			
			<h4 class="ma_title">재배면적 동향</h4> <p class="hw_red">근방의 면적과 함께 합산값을 입력해주세요</p>
			<div class="hw_clear"></div>	
