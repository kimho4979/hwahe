...
<input id="tp__market" type="radio" name="tab_item">
	...
	<div class="w3-container w3-margin w3-padding-16 w3-border-green select__info">
		<ul class="">
			...
			<li><strong>2.경매장 선택내역 : </strong><span class="pop__market__text"></span></li>
			<li><strong>3.품목 선택내역 : </strong><span class="pop__item__text"></span></li>
			<li><strong>4.품종 선택내역 : </strong><span class="pop__itemDtl__text"></span></li>
		</ul>
	</div>
