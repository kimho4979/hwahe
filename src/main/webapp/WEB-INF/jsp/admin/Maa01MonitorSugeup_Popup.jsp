...
<%   
	    request.setAttribute("pageTitle", "월간장미수급예측보고서"); 
    ...
    var fnObj = {
        pageStart: function(){
        	...
        	onchange:function(){
        		...
        		$('#AXInputMoney').attr("disabled","disabled");	  
        ...
        form: {
        	submit2: function(){				
				...
				$.ajax({
			           type : "POST",
			           url : "/maa01/updateMaa01MonitorSugeupPopup.json",
			           data :  "&"+$(frm).serialize(),
			           dataType : '',
...
<h4 class="ma_title">번호</h4><p class="hw_green"></p>
<div class="hw_clear"></div>	
<div class="hw_infouse_01" >
	<input name="SEQ" id="AXInputMoney" value='${SEQ_NO}' class="AXInput"  style="width:40px"/>
<span></span>
</div>
...
<h4 class="ma_title">제목</h4> <p class="hw_green">제목을 적어주세요.</p>
<div class="hw_clear"></div>	
...
<div class="hw_clear"></div>	
<h4 class="ma_title">파일 업로드</h4> <p class="hw_green">pdf를 업로드해 주세요</p>
...
<div><input style="${pageopen}"id="add" name="add" class="ma_add_01"  type="button" value="수정하기" onclick="fnObj.form.submit2();" /></div>
