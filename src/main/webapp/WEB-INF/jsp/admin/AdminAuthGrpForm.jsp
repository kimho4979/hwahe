...
<div class="sub_contents_title">그룹관리</div>
                               ...
                               this.target.setConfig({
           	                    ...
           	                    rows:[
                                       {display:true, addClass:"", style:"", list:[
                                           ...
                                           {label:"그룹 코드/명", labelWidth:"", type:"inputText", width:"150", key:"searchParams", addClass:"", valueBoxStyle:"", value:"",
           	        ...
           	        grid: {
           	                ...
           	                target.setConfig({
           	                    ...
           	                    */
           	                    colGroup : [
           	                        ...
           	                        {key:"grpAuthCd", label:"그룹코드", width:"150", align:"left",
                                           editor:{
                                               type:"text",
           				    maxLength: 50,
                                               disabled: function(){
           	                        ...
           	                        {key:"grpAuthNm", label:"그룹명", width:"160",
                                           editor:{
                                               type:"text",
           				    maxLength: 25
                                           }
                           ...
                           setPage: function(pageNo, searchParams){
                              ...
                              // fnObj.grid.pageNo = pageNo;
                               ...
                               app.ajax({
                                   type: "GET",
                                   url: "/admin/searchAdminAuthGrpList.json",
