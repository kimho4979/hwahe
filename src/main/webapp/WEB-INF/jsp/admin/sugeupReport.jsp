...
/* 
	...
	var fnObj = {
			pageStart : function() {
				...
				myGrid.setConfig({
					...
					modalOpen1 : function(gridData) {
						...
						myModal.open({
							type : "GET",
							url : "/maa01/Maa01MonitorSugeupUpdate_Popup.do",
			...
			modalOpen : function(gridData) {
				...
				myModal.open({
					type : "GET",
					url : "/maa01/Maa01MonitorReport_Popup.do",
					pars : ("&" + gridData).queryToObject(),
					top : axdom(window).scrollTop() + 30,
					closeByEscKey : true
				});
		...
		<div class="content_wrap">
			...
			<div class="navarea">
				...
				<!-- menu -->
				 ...
				 <input type="hidden"id="GUBN" value="1"/>  <!--  GUBN2 = 거래동향보고서 -->
				...
				<div class="real_contents">
					...
					<div class="shipment_schedule_all3">
						<div class="shipment_schedule_title">
							...
							<span class="half_title_purple">월간장미수급예측보고서</span>
						</div>
