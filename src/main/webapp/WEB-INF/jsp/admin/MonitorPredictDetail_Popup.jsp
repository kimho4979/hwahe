  ...
  <!-- 실제적인 rMateChartH5 라이브러리 끝-->
   ...
   <style type="text/css">
	...
	submit: function(){
				...
				$.ajax({
			           type : "POST",
			           url : "/admin/insertMonitorPredictDetail_Popup.json",
			           data : $(frm).serialize(),
			           dataType : '',   	           
			...
			submit2: function(){				
				...
				$.ajax({
			           type : "POST",
			           url : "/maa01/updateMonitorPredictDetail_Popup.json",
			           data :  "&"+$(frm).serialize(),
			           dataType : '',   	           
			           success : function(res){			        	    
			        	   $('#REG_DATE').attr("disabled","disabled");	  
...
<div class="hw_clear"></div>
<h4 class="ma_title">출하예정지역선택</h4> <p class="hw_green">출하예정지역을 선택하세요</p>
<div class="hw_clear"></div>	
<div class="hw_infouse_01">
...
<div class="hw_clear"></div>
<h4 class="ma_title">예정출하량</h4> <p class="hw_green">예정출하량을 적어주세요</p>
<div class="hw_clear"></div>	
<div class="hw_infouse_01" ><input name="QTY" id="AXInputMoney" value='${QTY}' class="AXInput" />
속
</div>
<div class="hw_clear"></div>	
<h4 class="ma_title">출하예정물량 요약</h4> <p class="hw_green">출하예정물량을 간략하게200자 이내로 적어주세요</p>
<div class="hw_clear"></div>	
