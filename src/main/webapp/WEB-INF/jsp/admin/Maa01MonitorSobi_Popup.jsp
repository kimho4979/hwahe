...
submit: function(){
				...
				$.ajax({
			           type : "POST",
			           url : "/maa01/Maa01MonitorSobiPopupInsert.json",
			           data : $(frm).serialize(),
			           dataType : '',   	           
			...
			submit2: function(){				
				...
				$.ajax({
			           type : "POST",
			           url : "/maa01/Maa01MonitorSobiPopupUpdate.json",
			           data :  "&"+$(frm).serialize(),
			           dataType : '',   	           
			           success : function(res){
...
<select name="GOOD_NAME" id="GOOD_NAME" class="variety_search_select">
	...
	<option value="타라">타라</option>  
</select>
</div>

<div class="hw_clear"></div>
<h4 class="ma_title">거래량</h4> <p class="hw_green">거래량을 적어주세요</p>
<div class="hw_clear"></div>	
<div class="hw_infouse_01" ><input name="QTY" id="AXInputMoney" value='${QTY}' class="AXInput" />
<span>속</span>
</div>
<div class="hw_clear"></div>	
<h4 class="ma_title">소비동향 내용요약</h4> <p class="hw_green">소비동향 내용을 간략하게200자 이내로 적어주세요</p>
<div class="hw_clear"></div>	
