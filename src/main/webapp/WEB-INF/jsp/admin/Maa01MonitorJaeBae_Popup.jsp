    ...
    var fnObj = {
        ...
        form: {			
			submit: function(){
				...
				$.ajax({
			           type : "POST",
			           url : "/maa01/Maa01MonitorJaeBaePopupInsert.json",
			           data : $(frm).serialize(),
			           dataType : '',   	           
			...
			submit2: function(){				
				...
				$.ajax({
			           type : "POST",
			           url : "/maa01/updateMaa01MonitorJaeBaePopup.json",
			           data :  "&"+$(frm).serialize(),
			           dataType : '',
			           success : function(res){		        	    
			        	   $('#REG_DATE').attr("disabled","disabled");	  
...
<div class="hw_clear"></div>
<h4 class="ma_title">전년대비면적</h4> <p class="hw_green">전년대비 재배면적을 선택해주세요</p>
<div class="hw_clear"></div>	
<div class="hw_infouse_01">
 	<input type="radio" name="STATUS" value="1" />증가
    <input type="radio" name="STATUS" value="2" />비슷
    <input type="radio" name="STATUS" value="3" />감소
</div>
<div class="hw_clear"></div>
<h4 class="ma_title">재배면적</h4><p class="hw_green">재배면적을 적어주세요</p>
<div class="hw_clear"></div>	
<div class="hw_infouse_01" ><input name="AREA" id="AXInputMoney" value='${AREA}' class="AXInput" />
<span>평</span>
</div>
<div class="hw_clear"></div>	
<h4 class="ma_title">재배면적 요약</h4> <p class="hw_green">재배면적 내용을 간략하게200자 이내로 적어주세요</p>
<div class="hw_clear"></div>	
