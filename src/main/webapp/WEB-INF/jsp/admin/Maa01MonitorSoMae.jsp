...
<script>
	...
	function grid_ajax() {
		...
		$.ajax({
			type : 'get',
			url : "/maa01/maa01MonitorSoMae.json",
	...
	function grid_ajax1(item) {
		...
		$.ajax({
			type : 'get',
			url : "/maa01/maa01MonitorSoMaeDetail.json",
	...
	var fnObj = {
		pageStart : function() {
			...
			myGrid.setConfig({
				...
				fixedColSeq : '',
				fitToWidth : true,
				colGroup : [ {key : "COMP_CODE",label : "출하코드",width : "80",	align : "center"}, 
				             {key : "USER_ID",	label : "사용자",	width : "90",align : "center"},
				             {key : "JAKWANG",label : "소매정보 등록 상태",width : "90",align : "center"}
				,
   ...
   /*           $("#ax-page-btn-search").bind("click", function(){
		...
		modalOpen : function(gridData) {
			...
			myModal.open({
				type : "GET",
				url : "/maa01/Maa01MonitorSoMae_Popup.do",
	...
	modalOpen1 : function(gridData) {
		...
		getCheckedList : function(index) {
			...
			$.ajax({
				type : 'get',
				url : "/maa01/deleteMonitorSoMaeDetail.json",
				data : deleteValue,
				dataType : '',
				success : function(res) {
				...
				<div class="real_contents">
					...
					<div class="shipment_schedule_all3">
						<div class="shipment_schedule_title">
							...
							<span class="half_title_purple">소매동향 등록 리스트</span>
						</div>
					...
					<div class="shipment_schedule_all3">
						<div class="shipment_schedule_title">
							<div class="half1_purple"></div>
							<span class="half_title_purple">소매동향 리스트</span>
						</div>
