...
<head>
	...
	<title>모니터요원 입력시스템-순별장미수급예측보고서</title>
	<!-- @@@@@@@@@@@@@@@@@@@@@@ css begin @@@@@@@@@@@@@@@@@@@@@@ -->
...
var fnObj = {
	...
	modalOpen: function(gridData){
		...
		myModal.open({    		 
			type: "GET",
			url:"/mcc02/similarInput_popup.do",				
	...
	getCheckedList: function(){
		...
		$.ajax({
			type : 'get',
			url : "/mntr/mcc02/deleteSimilarInfoInput.json",
			data : deleteValue,
			dataType : '',   	           
			success : function(res){                   	 
				grid_ajax();
...
<article>
	<div class="wrap">
		...
		<div class="hw_content"><!--컨텐츠 내용들어가는곳 시작-->
			<h3 class="hw_h3_ma"><span class="half_title">순별장미수급예측보고서</span></h3>
