				...
				success : function(res){
					...
					if(val != ""){
						for(var i=0; i<val.length; i++){
							$("#get1").append("<tr><td class='tc'><p>"+val[i].pumName+"</p></td><td class='tc'><p>"+addThousandSeparatorCommas(val[i].totQty)+"</p></td><td class='tc'><p>"+addThousandSeparatorCommas(val[i].maxAmt)+"</p></td><td class='tc'><p>"+addThousandSeparatorCommas(val[i].minAmt)+"</p></td><td class='tc'><p>"+addThousandSeparatorCommas(val[i].avgAmt)+"</p></td></tr>");
	...
	<div class="wrap">
		...
		<div class="lnb_box">
			<ul>
				...
				<li>경매실적 세부정보</li>
				<li><img src="../images/2020/m_right_img.png" alt="화살표"></li>
				<li class="m_right">품목별 총 거래정보</li>
			</ul>
		</div>
		<!--공통 HEADER(E)-->
