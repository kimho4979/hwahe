...
<head>
	...
	<meta name="description" content="품목경락가격">
	...
	var layoutStr = 
		'<rMateChart  backgroundColor="#ffffff" borderStyle="none">'
			...
			+'<Line2DChart showDataTips="true" dataTipDisplayMode="axis" paddingTop="0">'
				...
				+'</verticalAxis>'
			+'<series>'
				+'<Line2DSeries  yField="AVG_AMT_ONE" minimum="0" fill="#ffffff" radius="5" displayName="1순위"  itemRenderer="DiamondItemRenderer">'
				/* 아이템렌더러(데이터 마커) 테두리 색상 */
					+'<stroke><Stroke color="#fe6500" weight="1"/></stroke>'
						...
						+'</showDataEffect>'
					+'</Line2DSeries>'
				+'<Line2DSeries  yField="AVG_AMT_TWO" minimum="0" fill="#ffffff" radius="5" displayName="2순위"  itemRenderer="CircleItemRenderer">'
				/* itemRenderer는 Circle입니다 */
					+'<stroke><Stroke color="#ffb801" weight="1"/></stroke>'
						...
						+'</showDataEffect>'
					+'</Line2DSeries>'
				+'<Line2DSeries  yField="AVG_AMT_THR" minimum="0" fill="#ffffff" radius="5" displayName="3순위"  itemRenderer="TriangleItemRenderer">'
				/* itemRenderer는 Triangle입니다 */
					+'<stroke><Stroke color="#5fc502" weight="1"/></stroke>'
						...
						+'</showDataEffect>'
					+'</Line2DSeries>'
				+'<Line2DSeries  yField="AVG_AMT_FOU" minimum="0" fill="#ffffff" radius="5" displayName="4순위"  itemRenderer="CrossItemRenderer">'
				/* itemRenderer는 Triangle입니다 */
					+'<stroke><Stroke color="#666666" weight="1"/></stroke>'
						...
						+'</showDataEffect>'
					+'</Line2DSeries>'
				+'<Line2DSeries  yField="AVG_AMT_FIV" minimum="0" fill="#ffffff" radius="5" displayName="5순위"  itemRenderer="XShapeItemRenderer">'
				/* itemRenderer는 Triangle입니다 */
					+'<stroke><Stroke color="#5ECFCF" weight="1"/></stroke>'
						...
						+'</showDataEffect>'
				+'</Line2DSeries>'
				+'<Line2DSeries  yField="AVG_AMT_SIX" minimum="0" fill="#ffffff" radius="5" displayName="6순위" itemRenderer="IShapeItemRenderer">'
				/* itemRenderer는 Triangle입니다 */
		...
		$.ajax({
		    ...
		    success : function(res){
    			...
    			if(data1 != null && data1.length>0){
    				...
    				htmlTxt='<tr><td colspan="7">데이터가 없습니다.</td></tr>';
    			}
	...
	<div class="wrap">
		...
		<!--6tp-->
			...
			<div class="guide">
				...
				<ul class="guide_box">
					<li>· 경매 속수량이 많은 상위 6개 품목에 대한 경락가격을 공판장별로 비교분석 할수 있는 화면 </li>
					<li>· 최근1개월, 최근6개월, 최근1년 버튼 선택 시, 선택한 날짜의 데이터가 그래프에 표출</li>
					<li>· 조회목록의 1순위의 품목명이 그래프의 1순위의 품목명입니다. (품목명 : 1순위=1순위, 2순위=2순위 ....)</li>
