...
<head>
	...
	<title>소매가격 ㅣ aT 화훼유통정보 모니터요원 입력시스템</title>
...
var fnObj = {
	pageStart : function() {
		...
		$('#sub_top_menu a span').eq($('#sub_top_menu a span').index() + 5).addClass('a_purple');
		...
		myGrid.setConfig({
			...
			colGroup : [
				...
				{ key : "REG_DATE", label : "조사일자", width : "140", align : "center", pk : true }, 
				{ key : "PUM_NAME", label : "품목명", width : "140", align : "center" }, 
				{ key : "GOOD_NAME", label : "품종명", width : "100", align : "center" }, 
				{ key : "CHUL_NO", label : "출하코드", width : "100", align : "center" }, 
				{ key : "SAN_CD", label : "지역코드", width : "140", align : "center", display : false }, 
				{ key : "SALE_PRICE", label : "소매가격", width : "140", align : "right", formatter : "money" }, 
				{ key : "SAN_NAME", label : "지역명", width : "150" }, 
				{ key : "SEQ_NO", label : "일련번호", width : "100", align : "center", display : false }, 
				{
	...
	getCheckedList1update: function(index){
		if(confirm("소매가격정보을 수정하시겠습니까?") == true){
			...
			$.ajax({
				type : 'post',
				url : '/mntr/mbb01/gridListSeq.json',
				data : {
					seqNo : seqNo
				},
				dataType : '',
...
<form name="frm_ssq">
	...
	<div class="ma_half1_1" id="content">
		<span class="half_title2">소매가격</span>
	</div>
	...
	<div class="all_select_part">
		<span class="select_date_title1">소매가격 입력</span> 
		<span class="select_date_title2">소매가격을 적어주세요</span>
	</div>
	<div class="radio_btn_all">
		<label for="SALE_PRICE" class="blind">소매가격 입력</label>
		<input type="tel" id="SALE_PRICE" name="SALE_PRICE" class="text_input" />원
	</div>
</form>
...
<div id="bottom">
      <li class="lay1">
          <a href="/mbb01/mbb01.do"><button type=button class="pcver_btn">pc버전</button></a> 
