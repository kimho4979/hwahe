...
<head>
	...
	<title>출하물량 ㅣ aT 화훼유통정보 모니터요원 입력시스템</title>		
...
function grid_ajax2(){   
    ...
    $.ajax({
        type : 'get',
        url : "/mntr/maa01/gridList2Mobile.json",
	 ...
	 myGrid2.setConfig({
         ...
         colGroup : [  
			...
			},
			{
			    ...
			    return '<button type="button" name="delete" onclick="fnObj.getCheckedList2(' + this.index + ');"><i class="axi axi-trash-o"></i></button>';
			}
			},
             ...
             {key:"REG_DATE", label:"출하일자", width:"90", align:"center", display:false},
             ...
             {key:"BIGO", label:"출하내용", width:"400"},
             {
 			    ...
 			    return '<button type="button" name="update" onclick="fnObj.getCheckedList2update(' + this.index + ');"><i class="axi axi-mode-edit"></i></button>';
 			}
 			}
         ],
         colHeadAlign:"center",
	 ...
	 var d = new Date();
        ...
        getCheckedList2: function(index){
        	if (!confirm("정말 삭제 하시겠습니까?"))
        	 ...
        	 //출하물량 수정
         	getCheckedList2update: function(index){
        	 if(confirm("출하물량을 수정하시겠습니까?") == true){
        		 $("#lo1").hide();
        		 $("#lo3").show();
        		 $("body").scrollTop(0);
...
<!--  header end -->
	<div class="ma_half1_1"  id="content"><span class="white">출하물량</span></div>
...
<input type="hidden" id="GUBN" name="GUBN" value="2" />
...
<div class="all_select_part">
    ...
    <div class="radio_btn_all">
		<label for="regMonth" class="hw_item_search_title">월선택</label>
...
<select name="GOOD_NAME" id="GOOD_NAME" class="variety_search_select">
    ...
    <div class="select_btn_all">
      ...
      <label class="hw_search_title" for="hw_otherpart_search">기타지역 선택</lable>
    ...
    <div class="all_select_part">
        <span class="select_date_title1">출하량 입력</span>
        <span class="select_date_title2">출하량을 적어주세요</span>
    </div>
    <div class="radio_btn_all">
    	<label for="QTY" class="blind">출하량 입력</label>
    	<input type="tel" name="QTY" id="QTY"class="text_input"/>
        <span class="input_title" >속</span>
    </div>
    <div class="all_select_part">
        <span class="select_date_title1">출하물량 요약</span>
        <span class="select_date_title2">요약정보를 입력하세요(100~300자)</span>
    </div>
    <div class="radio_btn_all2">
    	<label for="BIGO" class="blind">출하물량 요약 입력</label>
	  ...
	  <div id="rt_sch_btn_lay" style="cursor:pointer;">
           <ul>
            ...
            <!--  <li class="lo1"><img src="../../../../images/common/sch_btn_img1.png" alt="img" /></li>
             ...
             <li class="lo2"><img id="lo2" src="../../../../images/common/sch_btn_ment.png" alt="등록하기" onclick="fnObj.form.submit();" style="display:block; margin:0 auto;"/></li>
   ...
   <br/><br/>
	...
	<div id="AXGridTarget2" style="height:100%;"></div>   
	<div id="bottom">
      <li class="lay1">
          <a href="/mab01/mab01.do"><button type=button class="pcver_btn">pc버전</button></a> 
