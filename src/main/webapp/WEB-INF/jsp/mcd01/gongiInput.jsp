...
var fnObj = {
    pageStart: function(){
		...
		myGrid.setConfig({
			...
			colGroup : [
				...
				{key:"SEQ", label:"번호", width:"30", align:"center", pk:true},                     	                 
				{key:"TITLE", label:"제목", width:"170"},
				{key:"INS_ID", label:"작성자",align:"center", width:"80"},                     	                                              
				{key:"ORIGIN_FILE_NAME", label:"파일", width:"120",align:"center"},
	...
	getCheckedList: function(){
		...
		$.ajax({
			type : 'get',
			url : "/mntr/mcd01/deleteGongiInfoInput.json",
			data : deleteValue,
			dataType : '',   	           
			success : function(res){                   	 
				grid_ajax();
...
<article>
	<div class="wrap">
		...
		<div class="hw_content"><!--컨텐츠 내용들어가는곳 시작-->
			<h3 class="hw_h3_ma"><span class="half_title">공지사항관리</span></h3>
