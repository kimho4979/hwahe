...
<article> 
	<div class="wrap">
		...
		<div class="content">
			<div class="title"><i class="axi axi-list"></i>산지코드조회 </div>
             ...
             bind: function () {
                 ...
                 var getColGroup = function () {
                     return [
                             ...
                             {key: "sanCd", label: "산지코드", width: "80" ,align: "center",},
                             {key: "sanName", label: "산지코드명", width: "100" ,align: "center",},
                             {key: "sanBigo", label: "비고", width: "80" ,align: "center",},
