...
<article> 
	<div class="wrap">
		...
		<div class="content">
			<div class="title"><i class="axi axi-list"></i>단위등급규격코드조회 </div>
               ...
               /* mediaQuery: {
				...
				rows:[
					{display:true, addClass:"", style:"", list:[
						{label:"", labelWidth:"100", type:"radioBox", width:"", key:"searcgCodeType", addClass:"secondItem", valueBoxStyle:"", value:"dan",
							options:[{optionValue:"dan", optionText:"단위코드검색", title:"코드"}, {optionValue:"lev", optionText:"등급코드검색"}, {optionValue:"size", optionText:"규격코드검색"},{optionValue:"poj", optionText:"포장코드검색"}],
             ...
             bind: function () {
                 ...
                 var getColGroup = function () {
                     return [
                             ...
                             {key: "CODE_NAME", label: "코드명", width: "100" ,align: "center",},
                             {key: "BIGO", label: "비고", width: "80" ,align: "center",},
