...
<article> 
	<div class="wrap">
		...
		<div class="content">
			<div class="title"><i class="axi axi-list"></i>정산전송내역 </div>
...
<c:if test="${searchSaleDate!='' && !empty searchSaleDate}">
  saleDate ='${searchSaleDate}'; 
</c:if>
               ...
               /* mediaQuery: {
				...
				rows:[
					{display:true, addClass:"", style:"", list:[
						...
						{label:"거래일자", labelWidth:"120", type:"inputText", width:"100", key:"searchSaleDate", addClass:"secondItem", valueBoxStyle:"padding-left:0px;",  value:(saleDate).print('yyyy-mm-dd'),
                            readonly:"readonly",
                            AXBind:{
                                type:"date", config:{selectType:"d",separator:"-", defaultSelectType:"d",
                                    align:"right", valign:"top"
                                }
                            }
                        },						
						{label:"", labelWidth:"", type:"selectBox", width:"", key:"searchSuccessYn", addClass:"", valueBoxStyle:"", value:"",
							options:[{optionValue:"", optionText:"전체보기"}, {optionValue:"Y", optionText:"성공"}, {optionValue:"N", optionText:"실패"}],
							AXBind:{
								type:"select", config:{
									onChange:function(){
										//toast.push(Object.toJSON(this));
             ...
             bind: function () {
                 ...
                 var getColGroup = function () {
                     return [
                             ...
                             {key:"successYn", label:"성공여부", width:"70", align:"center", formatter:function(){
                                if (this.value=="Y")
                                    return "성공";
                                else
                                    return "실패";
                            ...
                            {key: "stdCode", label: "표준코드", width: "80",align: "center",},
                            {key: "stdName", label: "표준코드명", width: "100",align: "center",},
                            {key: "cmpGood", label: "법인품목코드", width: "100",align: "center",},
                            {key: "pumName", label: "법인품목명", width: "100",align: "center",},                  
                          	{key: "totQty", label: "물량", width: "80", align: "right", formatter: "money"},
                            {key: "totAmt", label: "금액", width: "100", align: "right", formatter: "money"},
