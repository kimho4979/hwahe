 ...
 <link rel="stylesheet" type="text/css" href="<c:url value='/css/hw/common.css' />" />
  ...
  <script type="text/javascript" src="<c:url value='/rMateChart/rMateChartH5/Assets/Theme/theme.js' />"></script>
   ...
   <style type="text/css">
    ...
    var fnObj = {
        ...
        close:function(){
            ...
            if(parent){
                if(parent.myModal2) parent.myModal2.close();
            }
            else
            {
                window.close();
   ...
   function marketChange(value){
	   ...
	   $('#hw_otherpart_search').attr("disabled");	
	   $('#MARKET_CD').val(value);
	   if(value == '9999999999'){
   ...
   function otherpartChange(value){	   
	   //$('#MARKET_CD').val(value);	   
   }
...
<div class="hw_clear"></div>
	<div class="hw_infouse_01" id="pagesearch" >
		<%-- <input type="text" name="REG_DATE" id="REG_DATE" class="AXInput W100" value="${REG_DATE}" /> --%>
...
<div class="hw_clear"></div>
<h4 class="ma_title">출하지역선택</h4> <p class="hw_red">출하지역을 선택하세요</p>
<div class="hw_clear"></div>	
<div class="hw_infouse_01">
...
<div class="hw_clear"></div>
<h4 class="ma_title">출하량</h4> <p class="hw_red">출하량을 적어주세요</p>
<div class="hw_clear"></div>	
<div class="hw_infouse_01" ><input type="tel" name="QTY" id="AXInputMoney" class="AXInput" />
속
</div>
<div class="hw_clear"></div>	
<h4 class="ma_title">출하물량 요약</h4> <p class="hw_red">출하물량을 간략하게200자 이내로 적어주세요</p>
<div class="hw_clear"></div>	
