...
<title>화훼유통정보시스템 모니터요원 입력시스템 </title>
 ...
 <link rel="stylesheet" type="text/css" href="<c:url value='/css/hw/mobile_ma.css' />" />
        ...
        myModal.setConfig({
    	 ...
    	 myGrid.setConfig({
    	             ...
    	             colGroup : [
    	                 ...
    	                 {key:"ITEM_CD", label:"품종코드", width:"100", align:"center"},
    	             ],
    	             colHeadAlign:"center",
...
$(document).ready(fnObj.pageStart);
    ...
    $(document).ready(function(){
    	...
    	var tablndex = 0;
    	 ...
    	 $('.ma_half2').bind("click, mouseenter", function(){
    		 
    		 tabindex = $(this).index();
    		 
    		 $('.ma_half2').each(function(idx){
    		 $(this).find('img').attr('src',$(this).find('img').attr('src').replace('_off','_on'));
    		 if(tabindex !=idx) {
    		 $(this).find('img').attr('src',$(this).find('img').attr('src').replace('_on','_off'));
    		 }
    		 });
    		 $('.ma_half2 > div').eq(tabindex).show().siblings('div').hide();
    	 });
...
<div class="ma_all">
	...
	<a href="/maa01/maa01_02.do"><div class="ma_half2"><div class="half2_purple"></div><span class="half_title">출하예정물량 입력</span></div></a>
</div>
