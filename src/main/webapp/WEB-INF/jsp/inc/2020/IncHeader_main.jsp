...
<!-- 모바일_LNB(S) -->
					...
					<li>
						...
						<ul class="m_depth_02">
							<li>
								<a href="#!">경매통계<p>┼</p></a>
								<ul class="m_depth_03">
									<li><a href="/haa00_new/haa00_new.do">기간별 경매통계 조회</a></li>
		...
		<div class="header">
			<div class="header_menu">
				<div class="header_in">
					<!-- 모바일 햄버거 메뉴 버튼(S) -->
					<a href="#!" aria-label="메인페이지로 가기"  class="btn_m_menu"></a>
					<!-- 모바일 햄버거 메뉴 버튼(E) -->
					<!-- 왼쪽상단 로고(S) -->
					<div class="logo_box">
						<a href="/main/flowerMain.do" aria-label="메인페이지로 가기" class="btn_home"></a>
					</div>
					<!-- 왼쪽상단 로고(E) -->
					<!-- 헤더메뉴(S) -->
					<div class="menu_box">
