...
<section class="section content01">
	<div class="mbverWrap mb_ctHead">
		...
		<ul class="btnWrap">
			<li class="li01" id="liStrDate">
				<label for="searchStrDate">시작일자</label>
				<input type="text" class="calender" name="searchStrDate" id="searchStrDate" value="${param.searchStrDate}"/>
			</li><!-- li01 end -->
			<li class="li02">
				<label for="searchEndDate">종료일자</label>
				<input type="text" class="calender" name="searchEndDate" id="searchEndDate" value="${param.searchEndDate}"/>
			</li>
			<li class="li03"  id="pumSelectbox">
				<label for="itemCd" id="itemCdLab">품목선택</label>
				<select id="itemCd" name="itemCd" style="width: 150px;">
				</select>
			</li>
			<li class="li04"  id="goodSelectbox" style="display: none;">
