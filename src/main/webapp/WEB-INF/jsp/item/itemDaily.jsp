...
//						$('#jqGrid').hideCol('subgrid');
				...
				,	subGridRowExpanded: function(subgrid_id, row_id) {
						...
						$("#"+ subgrid_table_id).jqGrid({
							url : "/item/selectItemDailyDate.json"
						,	mtype : "post"
						,	postData:{
...
//								$('#jqGrid_'+ row_id +'_t').hideCol('subgrid');
			            ...
			            ,	subGridRowExpanded: function(subgrid_id2, row_id2) {
							...
							$("#"+subgrid_table_id2).jqGrid({
								url : "/item/selectItemDailyDateLevel.json"
							,	mtype : "post"
							,	postData:{
	...
	<div class="wrap">
		...
		<div class="lnb_box">
			<ul>
				...
				<li>공판장 통합정보</li>
				<li><img src="../images/2020/m_right_img.png" alt="화살표"></li>
				<li class="m_right">일자별 품목 경매정보</li>
			</ul>
		</div>
		<!--sub 헤더 (E)-->
		<!--서브 타이틀(S)-->
		...
		<div class="sub_guide">
			<div class="sub_info_box" id="boxContent">
				<h2 class="title_02">일자별 품목 경매정보</h2>
				<div class="info_box" >
