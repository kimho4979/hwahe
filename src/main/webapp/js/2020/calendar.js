...
(function (root, factory) {
    ...
    var defaults = {
        ...
        DATE_DIS_TPL = '<span class="m">{month}</span><span class="mm">{monthNm}</span>',

        ITEM_STYLE = 'style="width:{w}px;height:{h}px;line-height:{h}px"',
        //WEEK_ITEM_TPL = '<li ' + ITEM_STYLE + '>{wk}</li>',
        WEEK_ITEM_TPL = '<li ' + ITEM_STYLE + ' class="{class}">{wk}</li>',
        ...
        TEMPLATE = [
            ...
            '<span href="javascript:;" data-calendar-display-date class="calendar-display">',
